...
//			EmpUtility.createConnectionToInsert().prepareStatement(query).execute();
	...
	public boolean updateName(int id,String upname){
	...
	public boolean updateDept(int id,String upDept){
	...
	public boolean updateHDate(int id,String date){
	...
	public boolean updateAdd(int id,String ads){
